...
class ClusterLearner(nn.Module):
    def __init__(self, model, feature_extractor, optimizer, temperature, base_temperature, contrastive_local_scale, contrastive_global_scale, clustering_scale, use_head = False, use_normalize = False):
        ...
        # Loos_1 & Loss_2 = Local_MI_Maximization Loss & Global_MI_Maximization
...
#         contrastive_local_scale = torch.round(torch.tensor(avg_sentence_length)*(10**-1))-1 # method_4 : round
...
#         if contrastive_local_scale < 0:
#             contrastive_local_scale = 0
#         else :
#             contrastive_local_scale = contrastive_local_scale   
        ...
        #contrastive_global_loss *= (10**-2) - contrastive_local_scale
        contrastive_global_loss *= self.contrastive_global_scale
        #print('contrastive_global_scale :', (10**-2) - contrastive_local_scale*(10**-3))
